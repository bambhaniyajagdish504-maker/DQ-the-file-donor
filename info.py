...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/MoviesGroupG3")
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003144854316').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+-ECoJDFFc6ZmYjY1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MoviesGroupG3')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003357278960'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1002590436297')
